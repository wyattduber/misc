...
-(void)TileMoveDown{
    ...
    Row1Tile1.center = CGPointMake(Row1Tile1.center.x, Row1Tile1.center.x + 141);
    Row1Tile2.center = CGPointMake(Row1Tile2.center.x, Row1Tile2.center.x + 141);
    Row1Tile3.center = CGPointMake(Row1Tile3.center.x, Row1Tile3.center.x + 141);
    Row1Tile4.center = CGPointMake(Row1Tile4.center.x, Row1Tile4.center.x + 141);
    
    Row2Tile1.center = CGPointMake(Row2Tile1.center.x, Row2Tile1.center.x + 141);
    Row2Tile2.center = CGPointMake(Row2Tile2.center.x, Row2Tile2.center.x + 141);
    Row2Tile3.center = CGPointMake(Row2Tile3.center.x, Row2Tile3.center.x + 141);
    Row2Tile4.center = CGPointMake(Row2Tile4.center.x, Row2Tile4.center.x + 141);
    
    Row3Tile1.center = CGPointMake(Row3Tile1.center.x, Row3Tile1.center.x + 141);
    Row3Tile2.center = CGPointMake(Row3Tile2.center.x, Row3Tile2.center.x + 141);
    Row3Tile3.center = CGPointMake(Row3Tile3.center.x, Row3Tile3.center.x + 141);
    Row3Tile4.center = CGPointMake(Row3Tile4.center.x, Row3Tile4.center.x + 141);
    
    Row4Tile1.center = CGPointMake(Row4Tile1.center.x, Row4Tile1.center.x + 141);
    Row4Tile2.center = CGPointMake(Row4Tile2.center.x, Row4Tile2.center.x + 141);
    Row4Tile3.center = CGPointMake(Row4Tile3.center.x, Row4Tile3.center.x + 141);
    Row4Tile4.center = CGPointMake(Row4Tile4.center.x, Row4Tile4.center.x + 141);
    
    Row5Tile1.center = CGPointMake(Row5Tile1.center.x, Row5Tile1.center.x + 141);
    Row5Tile2.center = CGPointMake(Row5Tile2.center.x, Row5Tile2.center.x + 141);
    Row5Tile3.center = CGPointMake(Row5Tile3.center.x, Row5Tile3.center.x + 141);
    Row5Tile4.center = CGPointMake(Row5Tile4.center.x, Row5Tile4.center.x + 141);
