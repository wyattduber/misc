...
//  Tower Defense
//
//  Created by Todd Duberstein on 6/14/14.
...
-(IBAction)Tower1Space:(id)sender{
    ...
    if (Tower1 == YES) {
        ...
        UIImage *buttonImage = [UIImage imageNamed:@"PT.png"];
...
-(void)Moving{
    ...
    Tower3Bullet.center = CGPointMake(Tower3Bullet.center.x + Bullet3Movement, Tower3Bullet.center.y);
    ...
    if((CGRectIntersectsRect(Tank.frame, Tower2DangerZone.frame)) && Tower2 == YES) {
        ...
        Bullet2Movement = 0;
        Tower2Bullet.hidden = YES;
        Tower1Bullet.center = CGPointMake(Tower1Space.center.x, Tower2Space.center.y);
    }
    ...
    if (CGRectIntersectsRect(Tank.frame, Corner2.frame)) {
        Tank.image = [UIImage imageNamed:@"TankLeft.png"];
        TankX = 2;
        TankY = 0;
    }
...
-(void)viewDidLoad
{
    ...
    Corner2.hidden = YES;
    Tank.hidden = YES;
    Tank.center = CGPointMake(-51, 175);
